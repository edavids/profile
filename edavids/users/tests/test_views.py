...
from edavids.users.forms import UserChangeForm
from edavids.users.models import User
from edavids.users.tests.factories import UserFactory
from edavids.users.views import (
    UserRedirectView,
    UserUpdateView,
    user_detail_view,
)
